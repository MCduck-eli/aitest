...
exports.getCategoryForLesson = exports.getTopicsUpToLesson = exports.getLessonsUpTo = exports.getLessonById = exports.FoundationSyllabus = exports.SubjectCategories = void 0;
...
const getLessonById = (lessonId) => exports.FoundationSyllabus.find((lesson) => lesson.id === lessonId);
exports.getLessonById = getLessonById;
const getLessonsUpTo = (lessonId) => exports.FoundationSyllabus.filter((lesson) => lesson.id >= 1 && lesson.id <= lessonId);
exports.getLessonsUpTo = getLessonsUpTo;
const getTopicsUpToLesson = (lessonId) => (0, exports.getLessonsUpTo)(lessonId).flatMap((lesson) => lesson.topics);
exports.getTopicsUpToLesson = getTopicsUpToLesson;
const getCategoryForLesson = (lessonId) => exports.SubjectCategories.find((category) => lessonId >= category.fromLesson && lessonId <= category.toLesson);
exports.getCategoryForLesson = getCategoryForLesson;
